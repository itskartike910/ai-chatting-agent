    ...
    try {
      ...
      while (!taskCompleted && this.currentStep < this.maxSteps && !this.cancelled) {
        ...
        if (initialPlan && (this.currentStep === 1 || isResume)) {
          ...
          // CRITICAL FIX: Clear initialPlan and reset isResume so they ONLY execute once on start/resume
          // and DO NOT overwrite subsequent steps generated by the PlannerAgent!
          initialPlan = null;
          isResume = false;
        }
