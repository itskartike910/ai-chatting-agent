...
const LabubuSearch = ({ onBack, userProfile, onLogout }) => {
  ...
  return (
    <motion.div
      className="w-full h-full min-h-screen max-w-[650px] bg-gradient-to-br from-[#0f0a2e] via-[#2d1b69] to-[#4c1d95] p-4 font-labubu flex flex-col items-center relative overflow-hidden"
      style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, margin: 0, padding: 16 }}
    ...
    >
      ...
      {/* Header */}
      <div className="flex flex-col items-center w-full max-w-[580px] mx-auto mt-4 mb-6 relative z-10">
        {/* Top navigation */}
