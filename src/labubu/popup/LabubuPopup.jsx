...
const Popup = () => {
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center w-full h-full min-h-screen max-w-[650px] bg-gradient-to-br from-[#1a144b] via-[#3a1c71] to-[#6e1e9c] relative overflow-hidden font-labubu"
    ...
    >
      <div className="w-full max-w-[580px] bg-white/10 backdrop-blur-md rounded-2xl p-8 mx-4 flex flex-col items-center shadow-2xl border border-white/20">
